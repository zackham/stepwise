...
class StepDefinition:
    ...
    session: str | None = None  # named session this step participates in
    fork_from: str | None = None  # fork a new session from this parent session
    continue_session: bool = False  # LEGACY: reuse agent session across loop iterations
