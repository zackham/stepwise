...
import { durationBetween, buildBoundarySegmentMap } from "./session-transcript-utils";
...
export function SessionTranscriptView({
  ...
  const { showBackToBottom, showJumpToTop, scrollToBottom, scrollToTop } = useAutoScroll(containerRef, version);
