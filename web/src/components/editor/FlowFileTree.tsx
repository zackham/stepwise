...
export function FlowFileTree({
  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center justify-between px-3 py-1.5 text-[11px] font-medium text-zinc-500 uppercase tracking-wide">
        <span>Files</span>
        {onRefresh && (
          <button
            onClick={onRefresh}
...
function TreeNodeRow({
    ...
    return (
      <>
        <button
          ...
          className="flex items-center gap-1 w-full text-left text-xs text-zinc-400 hover:text-zinc-200 py-0.5 rounded hover:bg-zinc-800/50"
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center gap-1.5 w-full text-left text-xs py-0.5 rounded",
        isSelected
